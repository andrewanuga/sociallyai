  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">Sign in to your SociallyAI workspace</p>
      </div>

      <div className="p-8 rounded-2xl border border-border bg-card/80 backdrop-blur-sm shadow-xl">
        {/* Google SSO */}
        <Button type="button" variant="outline" className="w-full mb-6 h-11 gap-3" onClick={handleGoogleLogin}>
          {/* Google icon — official brand colours kept for recognisability */}
