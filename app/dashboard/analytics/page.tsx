import { BarChart3, TrendingUp, TrendingDown, Eye, Heart, Users, DollarSign, ArrowUpRight } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { Progress } from "@/components/ui/progress";

const PLATFORM_STATS = [
  { name: "LinkedIn", color: "#0077B5", letter: "in", impressions: "112K", engagements: "18.4K", followers: "+428", growth: "+22%", positive: true },
  { name: "X (Twitter)", color: "#1DA1F2", letter: "X", impressions: "89K", engagements: "14.2K", followers: "+312", growth: "+15%", positive: true },
  { name: "Instagram", color: "#E1306C", letter: "IG", impressions: "63K", engagements: "8.9K", followers: "+204", growth: "+41%", positive: true },
  { name: "TikTok", color: "#888", letter: "TT", impressions: "20.9K", engagements: "1.3K", followers: "+89", growth: "-2%", positive: false },
];
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="p-6 rounded-xl border border-green-500/20 bg-green-500/5 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Badge variant="green">Active tracking</Badge>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: "Attributed Revenue", value: "₦847,000", icon: DollarSign, color: "text-green-400" },
            { label: "Total Link Clicks", value: "8,420", icon: ArrowUpRight, color: "text-blue-400" },
            { label: "Conversions", value: "284", icon: Users, color: "text-purple-400" },
            { label: "Avg Conversion Rate", value: "3.4%", icon: TrendingUp, color: "text-orange-400" },
          ].map((item, i) => (
          ...
          {CONTENT_PERFORMANCE.map((c, i) => (
            <div key={i} className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-6 text-sm flex-shrink-0">
                ...
                <span className="text-green-400 w-12 text-right">{c.avgEng}</span>
              </div>
            </div>
          ))}
        </div>
