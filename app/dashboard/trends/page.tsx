      ...
      <div className="mb-6 flex items-start justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-0.5">
            AI-matched trending topics with personalized draft suggestions based on your history
          </p>
        </div>
        <Button
          variant="outline"
          ...
          {TRENDS.map((trend, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-3">
                <span className={`text-xs font-medium ${trend.momentumColor}`}>
                  ● {trend.momentum}
                </span>
