...
const COMPARISON_ROWS: {
  ...
  {
    feature: "Autonomous commenting agents",
    socially: true,
    buffer: false,
    hootsuite: false,
    taplio: "partial",
  ...
  {
    feature: "Predictive performance scoring",
    socially: true,
    buffer: false,
    hootsuite: false,
    taplio: false,
  ...
  {
    feature: "Revenue attribution (ROI Pulse)",
    socially: true,
    buffer: false,
    hootsuite: false,
    taplio: false,
  ...
  {
    feature: "Trend-to-Draft automation",
    socially: true,
    buffer: false,
    hootsuite: false,
    taplio: "partial",
  ...
  {
    feature: "Self-hosted AI (no per-token fees)",
    socially: true,
    buffer: false,
    hootsuite: false,
    taplio: false,
  ...
  {
    feature: "Naira-denominated pricing",
    socially: true,
    buffer: false,
    hootsuite: false,
    taplio: false,
  ...
  {
    feature: "Paystack / Flutterwave payments",
    socially: true,
    buffer: false,
    hootsuite: false,
    taplio: false,
  ...
  {
    feature: "Smart Inbox Triage (lead sorting)",
    socially: true,
    buffer: false,
    hootsuite: "partial",
    taplio: false,
  ...
  {
    feature: "Brand voice from URL scrape",
    socially: true,
    buffer: false,
    hootsuite: false,
    taplio: false,
  ...
  {
    feature: "WhatsApp Channels support",
    socially: true,
    buffer: false,
    hootsuite: false,
    taplio: false,
...
function CheckCell({
  ...
  if (value === true)
    return (
      <Check
        className={`w-5 h-5 mx-auto ${highlight ? "text-purple-400" : "text-green-500"}`}
      />
    );
  if (value === "partial")
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            We&apos;re not just another social media scheduler. We&apos;re a category
            upgrade.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center gap-4 mt-4 text-xs text-muted-foreground px-4">
            ...
            <div className="flex items-center gap-1.5">
              <Minus className="w-3.5 h-3.5 text-yellow-500 opacity-60" />{" "}
              Partial / limited
            </div>
            <div className="flex items-center gap-1.5">
