        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-6 leading-tight">
              ...
              <br />
              <span className="text-green-400">actually made you money.</span>
            </h2>
            ...
            <p className="text-sm text-muted-foreground italic">
              "ROI Pulse turned our sociallyAI subscription from a cost into an
          ...
          >
            {/* Header card */}
            <div className="p-5 rounded-2xl border border-green-500/20 bg-card">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-green-500/15 text-green-400 text-sm font-medium">
            ...
            {ATTRIBUTION_EXAMPLES.map((item, i) => (
              <motion.div
                ...
                className="p-4 rounded-xl border border-border bg-card hover:border-green-500/20 transition-colors group"
              >
