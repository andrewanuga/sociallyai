...
export const PLANS: Record<PlanId, PlanConfig> = {
  free: { id: "free", name: "Free", price: 0, generations: 28, accounts: 1, bots: 0 },
  basic: { id: "basic", name: "Basic", price: 5000, planCodeEnv: "NEXT_PUBLIC_PAYSTACK_BASIC_PLAN", generations: 100, accounts: 3, bots: 0 },
  pro: { id: "pro", name: "Pro", price: 12000, planCodeEnv: "NEXT_PUBLIC_PAYSTACK_PRO_PLAN", generations: 500, accounts: 7, bots: 1 },
  advanced: { id: "advanced", name: "Advanced", price: 25000, planCodeEnv: "NEXT_PUBLIC_PAYSTACK_ADVANCED_PLAN", generations: 1000, accounts: 15, bots: 3 },
};
